...
const TRANSLATIONS: Translations = {
  ...
  'transfer.header.title': { fr: 'Nouveau virement', en: 'New transfer', zh: '新建转账' },
  'transfer.header.subtitle': { fr: "Transférez de l'argent rapidement et en toute sécurité", en: 'Transfer money quickly and securely', zh: '快速安全地转账' },
  'transfer.section.type': { fr: 'TYPE DE VIREMENT', en: 'TRANSFER TYPE', zh: '转账类型' },
  'transfer.type.internal.title': { fr: 'Compte à compte interne', en: 'Internal account to account', zh: '内部账户间转账' },
  'transfer.type.internal.subtitle': { fr: 'Entre vos comptes', en: 'Between your accounts', zh: '在您自己的账户之间' },
  'transfer.type.external.title': { fr: 'Compte à compte externe', en: 'External account to account', zh: '外部账户间转账' },
  'transfer.type.external.subtitle': { fr: 'Vers un autre bénéficiaire', en: 'To another beneficiary', zh: '转至其他收款人' },
  'transfer.form.internal.title': { fr: 'Virement interne', en: 'Internal transfer', zh: '内部转账' },
  'transfer.form.external.title': { fr: 'Virement externe', en: 'External transfer', zh: '外部转账' },
  'transfer.form.source.label': { fr: 'Compte source', en: 'Source account', zh: '来源账户' },
  'transfer.form.source.placeholder': { fr: 'Numéro de compte source', en: 'Source account number', zh: '来源账户号码' },
  'transfer.form.beneficiary.label.internal': { fr: 'Compte bénéficiaire', en: 'Beneficiary account', zh: '收款账户' },
  'transfer.form.beneficiary.placeholder.internal': { fr: 'Numéro de compte destinataire', en: 'Destination account number', zh: '收款账户号码' },
  'transfer.form.beneficiary.label.external': { fr: 'Compte destinataire', en: 'Destination account', zh: '目的账户' },
  'transfer.form.beneficiary.placeholder.external': { fr: 'Code client ou IBAN', en: 'Client code or IBAN', zh: '客户代码或IBAN' },
  'transfer.form.amount.label': { fr: 'Montant', en: 'Amount', zh: '金额' },
  'transfer.action.submit': { fr: 'Effectuer le virement', en: 'Make the transfer', zh: '执行转账' },
  'transfer.note.secure': { fr: 'Vos transactions sont sécurisées et cryptées', en: 'Your transactions are secure and encrypted', zh: '您的交易是安全且加密的' },

  // Cards (Quick Action)
  'cards.header.title': { fr: 'Mes cartes', en: 'My cards', zh: '我的卡片' },
  'cards.header.subtitle': { fr: '2 cartes actives', en: '2 active cards', zh: '2 张已激活卡' },
  'cards.stats.cards': { fr: 'Cartes', en: 'Cards', zh: '卡片' },
  'cards.stats.totalBalance': { fr: 'Solde total', en: 'Total balance', zh: '总余额' },
  'cards.stats.transactions': { fr: 'Transactions', en: 'Transactions', zh: '交易' },
  'cards.quick.title': { fr: 'Actions rapides', en: 'Quick actions', zh: '快速操作' },
  'cards.quick.block.title': { fr: 'Bloquer', en: 'Block', zh: '冻结' },
  'cards.quick.block.subtitle': { fr: 'Carte temporairement', en: 'Card temporarily', zh: '暂时冻结卡片' },
  'cards.quick.manage.title': { fr: 'Gérer', en: 'Manage', zh: '管理' },
  'cards.quick.manage.subtitle': { fr: 'Limites et paramètres', en: 'Limits and settings', zh: '限额与设置' },
  'cards.quick.order.title': { fr: 'Commander', en: 'Order', zh: '申请' },
  'cards.quick.order.subtitle': { fr: 'Nouvelle carte', en: 'New card', zh: '新卡' },
  'cards.details.title': { fr: 'Détails de la carte', en: 'Card details', zh: '卡片详情' },
  'cards.details.fullNumber': { fr: 'Numéro complet', en: 'Full number', zh: '完整卡号' },
  'cards.details.cvv': { fr: 'CVV', en: 'CVV', zh: 'CVV' },
  'cards.details.expiry': { fr: "Date d'expiration", en: 'Expiration date', zh: '到期日期' },
  'cards.details.type': { fr: 'Type', en: 'Type', zh: '类型' },
  'cards.limits.title': { fr: 'Limites de dépenses', en: 'Spending limits', zh: '支出限额' },
  'cards.limits.edit': { fr: 'Modifier', en: 'Edit', zh: '修改' },
  'cards.limits.dailyPayments': { fr: 'Paiements quotidiens', en: 'Daily payments', zh: '每日支付' },
  'cards.limits.today': { fr: "Aujourd'hui", en: 'Today', zh: '今天' },
  'cards.limits.monthlyWithdrawals': { fr: 'Retraits mensuels', en: 'Monthly withdrawals', zh: '每月取款' },
  'cards.limits.thisMonth': { fr: 'Ce mois', en: 'This month', zh: '本月' },
  'cards.limits.usedSuffix': { fr: 'utilisé', en: 'used', zh: '已用' },
  'cards.recent.title': { fr: 'Transactions récentes', en: 'Recent transactions', zh: '最近交易' },
  'cards.recent.seeAll': { fr: 'Tout voir', en: 'See all', zh: '查看全部' },
  'cards.security.message': { fr: 'Vos cartes sont protégées par la technologie 3D Secure et des alertes en temps réel', en: 'Your cards are protected by 3D Secure technology and real-time alerts', zh: '您的卡片受 3D Secure 技术和实时警报保护' },
  'cards.card.status.active': { fr: 'Active', en: 'Active', zh: '已激活' },
  'cards.card.meta.holderLabel': { fr: 'TITULAIRE', en: 'HOLDER', zh: '持卡人' },
  'cards.card.meta.expiryLabel': { fr: 'EXPIRE LE', en: 'EXPIRES', zh: '到期' },
  'cards.sheet.title': { fr: 'Actions sur la carte', en: 'Card actions', zh: '卡片操作' },
  'cards.sheet.block.title': { fr: 'Bloquer la carte', en: 'Block the card', zh: '冻结卡片' },
  'cards.sheet.block.subtitle': { fr: 'Temporairement ou définitivement', en: 'Temporarily or permanently', zh: '暂时或永久' },
  'cards.sheet.pin.title': { fr: 'Modifier le code PIN', en: 'Change PIN code', zh: '更改PIN码' },
  'cards.sheet.pin.subtitle': { fr: 'Changez votre code de sécurité', en: 'Change your security code', zh: '更改您的安全码' },
  'cards.sheet.renew.title': { fr: 'Renouveler', en: 'Renew', zh: '续卡' },
  'cards.sheet.renew.subtitle': { fr: 'Commander une nouvelle carte', en: 'Order a new card', zh: '申请新卡' },
  'common.cancel': { fr: 'Annuler', en: 'Cancel', zh: '取消' },
  'common.ok': { fr: 'OK', en: 'OK', zh: '确定' },
  'cards.modal.info.title': { fr: 'INFO', en: 'INFO', zh: '信息' },
  'cards.modal.info.body': { fr: 'FONCTIONNALITE A VENIR', en: 'FEATURE COMING SOON', zh: '功能即将推出' },
  'cards.modal.newCard.title': { fr: 'Nouvelle carte', en: 'New card', zh: '新卡' },
  'cards.modal.newCard.body': { fr: 'Souhaitez-vous demander une nouvelle\ncarte ?', en: 'Do you want to request a new card?', zh: '您想申请一张新卡吗？' },
  ...
  'cards.alert.copy.body': { fr: 'Copié dans le presse papier', en: 'Copied to clipboard', zh: '已复制到剪贴板' },
  'cards.alert.error.title': { fr: 'Erreur', en: 'Error', zh: '错误' },
  'cards.alert.copy.error': { fr: 'Impossible de copier le numéro', en: 'Unable to copy the number', zh: '无法复制号码' },
  'cards.alert.confirmation.title': { fr: 'Confirmation', en: 'Confirmation', zh: '确认' },
  'cards.alert.newCardSaved': { fr: 'Votre demande de nouvelle carte a été enregistrée', en: 'Your new card request has been recorded', zh: '您的新卡申请已记录' },

  // Dates (extended)
  'dashboard.date.3days': { fr: 'Il y a 3 jours', en: '3 days ago', zh: '三天前' },
};
