  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.headerCard, { backgroundColor: colors.card }]}>
          <View style={styles.avatarWrap}>
            <View style={[styles.avatarCircle, { backgroundColor: colors.primary }]}>
              <Text style={[styles.avatarInitials, { color: '#fff' }]}>DM</Text>
            </View>
            <View style={[styles.avatarCamera, { backgroundColor: colors.success }]}>
              <Ionicons name="camera" size={14} color="#fff" />
            </View>
          </View>
          <Text style={[styles.profileName, { color: colors.text }]}>Derly MOUPEPIDI</Text>
          <Text style={[styles.profileCode, { color: colors.text + '60' }]}>Code: LPO01354</Text>
          <View style={[styles.memberBadge, { backgroundColor: isDark ? colors.success + '20' : colors.success + '10' }]}>
            <Ionicons name="shield-checkmark" size={14} color={colors.success} />
            <Text style={[styles.memberText, { color: colors.success }]}>Membre depuis Octobre 2025</Text>
          </View>
        </View>
        ...
        <View style={[styles.infoCard, { backgroundColor: colors.card }]}>
          <View style={styles.infoRow}>
            <View style={[styles.infoIconBg, { backgroundColor: isDark ? colors.primary + '20' : colors.primary + '10' }]}>
              <Ionicons name="mail" size={18} color={colors.primary} />
            </View>
            <View style={styles.infoTexts}>
              <Text style={[styles.infoLabel, { color: colors.text + '60' }]}>Email</Text>
              <Text style={[styles.infoValue, { color: colors.text }]}>derly.moupepidibis-afrique.tech</Text>
            </View>
          </View>
          <View style={[styles.divider, { backgroundColor: isDark ? colors.border : '#E5E5EA' }]} />
          <View style={styles.infoRow}>
            <View style={[styles.infoIconBg, { backgroundColor: isDark ? colors.success + '20' : colors.success + '10' }]}>
              <Ionicons name="call" size={18} color={colors.success} />
            </View>
            <View style={styles.infoTexts}>
              <Text style={[styles.infoLabel, { color: colors.text + '60' }]}>Téléphone</Text>
              <Text style={[styles.infoValue, { color: colors.text }]}>+241 77 68 38 55</Text>
            </View>
          </View>
          <View style={[styles.divider, { backgroundColor: isDark ? '#333' : '#F0F0F0' }]} />
          <View style={styles.infoRow}>
            <View style={[styles.infoIconBg, { backgroundColor: isDark ? colors.warning + '20' : colors.warning + '10' }]}>
              <Ionicons name="location" size={18} color={colors.warning} />
            </View>
            <View style={styles.infoTexts}>
              <Text style={[styles.infoLabel, { color: colors.text + '60' }]}>Adresse</Text>
              <Text style={[styles.infoValue, { color: colors.text }]}>Nzend Ayoong, Nouvelle cité\nLibreville, Gabon</Text>
              <Text style={[styles.infoLabel, { color: colors.text + '60' }]}>Libreville, Gabon</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.sectionBlock}>
          <Text style={[styles.sectionTitle, { color: colors.text + '80' }]}>Informations personnelles</Text>
          <TouchableOpacity style={[styles.editRow, { backgroundColor: colors.card }]} activeOpacity={0.8} onPress={() => setEditVisible(true)}>
            <View style={styles.editRowLeft}>
              <View style={[styles.infoIconBg, { backgroundColor: isDark ? colors.primary + '20' : colors.primary + '10' }]}>
                <Ionicons name="person" size={18} color={colors.primary} />
              </View>
              <Text style={[styles.editRowText, { color: colors.text }]}>Modifier le profil</Text>
            </View>
              <Ionicons name="chevron-forward" size={18} color={isDark ? '#666' : '#C0C0C0'} />
          </TouchableOpacity>
        </View>

        {/* Documents section */}
        <View style={styles.sectionBlock}>
          <Text style={[styles.sectionTitle, { color: colors.text + '80' }]}>Documents</Text>
          <View style={[styles.docCard, { backgroundColor: colors.card }]}>
            <TouchableOpacity style={styles.docItem} activeOpacity={0.7} onPress={() => navigation.navigate('Statements' as never)}>
              <View style={styles.docLeft}>
                ...
                <Text style={[styles.docTitle, { color: colors.text }]}>Relevés de compte</Text>
              </View>
              <Ionicons name="chevron-forward" size={18} color={isDark ? '#666' : '#C0C0C0'} />
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.docItem} activeOpacity={0.7} onPress={() => setTxVisible(true)}>
              <View style={styles.docLeft}>
                ...
                <Text style={[styles.docTitle, { color: colors.text }]}>Historique des transactions</Text>
              </View>
              <Ionicons name="chevron-forward" size={18} color={isDark ? '#666' : '#C0C0C0'} />
            </TouchableOpacity>
            ...
            <TouchableOpacity style={[styles.docItem, styles.docItemLast]} activeOpacity={0.7} onPress={() => console.log('Téléchargements')}>
              <View style={styles.docLeft}>
                ...
                <Text style={[styles.docTitle, { color: colors.text }]}>Téléchargements</Text>
              </View>
              <Ionicons name="chevron-forward" size={18} color={isDark ? '#666' : '#C0C0C0'} />
            </TouchableOpacity>
          </View>
        ...
        <View style={styles.versionContainer}>
          ...
          <Text style={[styles.copyrightText, { color: colors.text + '40' }]}>© 2025 La Pepite EMF</Text>
        </View>
      </ScrollView>

      {/* Modal Modifier le profil */}
      <Modal visible={editVisible} transparent animationType="fade" onRequestClose={() => setEditVisible(false)}>
        <View style={[styles.modalOverlay, { backgroundColor: isDark ? 'rgba(0,0,0,0.6)' : 'rgba(0,0,0,0.35)' }]}>
          <View style={[styles.modalBox, { backgroundColor: colors.card }]}>
            <TouchableOpacity style={[styles.modalClose, { backgroundColor: isDark ? '#333' : '#F7F7F7' }]} onPress={() => setEditVisible(false)}>
              <Ionicons name="close" size={24} color={colors.text} />
            </TouchableOpacity>
            <View style={[styles.modalHandle, { backgroundColor: isDark ? '#444' : '#EAEAEA' }]} />
            <Text style={[styles.modalTitle, { color: colors.text }]}>Modifier le profil</Text>
            <Text style={[styles.modalText, { color: isDark ? '#ccc' : '#777' }]}>
              Pour modifier vos informations personnelles, veuillez contacter votre agence ou le service client.
            </Text>
            <View style={styles.actionsRow}>
              <TouchableOpacity style={[styles.actionBtn, { backgroundColor: colors.primary }]} activeOpacity={0.8} onPress={handleCall}>
                <Ionicons name="call" size={20} color="#fff" />
                <Text style={styles.actionTextLight}>Appeler</Text>
              </TouchableOpacity>
              <TouchableOpacity style={[styles.actionBtn, { backgroundColor: colors.success }]} activeOpacity={0.8} onPress={handleEmail}>
      ...
      <Modal visible={txVisible} transparent animationType="fade" onRequestClose={() => setTxVisible(false)}>
        <View style={[styles.modalOverlay, { backgroundColor: isDark ? 'rgba(0,0,0,0.6)' : 'rgba(0,0,0,0.35)' }]}>
          <View style={[styles.modalBox, { backgroundColor: colors.card }]}>
            <TouchableOpacity style={[styles.modalClose, { backgroundColor: isDark ? '#333' : '#F7F7F7' }]} onPress={() => setTxVisible(false)}>
              <Ionicons name="close" size={24} color={colors.text} />
            </TouchableOpacity>
            <View style={[styles.modalHandle, { backgroundColor: isDark ? '#444' : '#EAEAEA' }]} />
            <Text style={[styles.modalTitle, { color: colors.text }]}>Historique des transactions</Text>

            {/* Boutons d'action */}
            <View style={styles.txActionsRow}>
              <TouchableOpacity style={[styles.actionBtnOutline, { borderColor: colors.border, backgroundColor: colors.card }]} activeOpacity={0.8} onPress={() => setDateInfoVisible(true)}>
                <Ionicons name="calendar" size={18} color={colors.primary} />
                <Text style={[styles.actionTextPrimary, { color: colors.primary }]}>Filtrer par date</Text>
              </TouchableOpacity>
              <TouchableOpacity style={[styles.txActionBtn, { backgroundColor: colors.primary }]} activeOpacity={0.8} onPress={handleExportTransactionsPdf}>
            ...
            <View style={styles.txList}>
              {txData.map((t) => (
                <View key={t.id} style={[styles.txItem, { backgroundColor: colors.card }]}>
                  <View style={styles.txLeft}>
                    <View style={[styles.txIconBg, { backgroundColor: t.type === 'entree' ? (isDark ? '#1a3d2e' : '#E9FFF3') : (isDark ? '#4a1a1a' : '#FFECEC') }]}>
                      <Ionicons name={t.type === 'entree' ? 'arrow-down' : 'arrow-up'} size={18} color={t.type === 'entree' ? colors.success : colors.error} />
                    </View>
                    <View>
                      <Text style={[styles.txTitle, { color: colors.text }]}>{t.title}</Text>
                      <Text style={[styles.txDate, { color: colors.text + '60' }]}>{t.date}</Text>
                    </View>
                  </View>
                  <Text style={[styles.txAmount, { color: t.type === 'entree' ? colors.success : colors.error }]}>{t.amount}</Text>
                </View>
              ))}
            </View>
          </View>
      ...
      <Modal visible={dateInfoVisible} transparent animationType="fade" onRequestClose={() => setDateInfoVisible(false)}>
        <View style={[styles.modalOverlay, { backgroundColor: isDark ? 'rgba(0,0,0,0.6)' : 'rgba(0,0,0,0.35)' }]}>
          <View style={[styles.modalBox, { backgroundColor: colors.card }]}>
            <TouchableOpacity style={[styles.modalClose, { backgroundColor: isDark ? '#333' : '#F7F7F7' }]} onPress={() => setDateInfoVisible(false)}>
              <Ionicons name="close" size={24} color={colors.text} />
            </TouchableOpacity>
            <View style={styles.modalHandle} />
            <Text style={[styles.modalTitle, { color: colors.text }]}>Informations</Text>
            <Text style={[styles.modalText, { color: isDark ? '#ccc' : '#777' }]}>La sélection de date sera disponible prochainement.</Text>
            <View style={styles.actionsRow}>
              <TouchableOpacity style={[styles.actionBtn, { backgroundColor: colors.primary }]} activeOpacity={0.8} onPress={() => setDateInfoVisible(false)}>
