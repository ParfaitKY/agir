...
export const LoginScreen: React.FC = () => {
  ...
  useEffect(() => {
    if (code.length === 6) handleValidation();
  }, [code]);
  ...
  return (
    <View style={styles.container}>
      <Animated.View style={[styles.card, { transform: [{ translateX: shakeAnim }] }]}>
        ...
        <Text style={styles.subtitle}>Veuillez entrer votre code de sécurité</Text>
              ...
              {row.map((key) => (
                ...
                >
                  {key === 'del' ? (
                    ...
                    <Ionicons name="finger-print-outline" size={30} color="#007AFF" />
                  ) : (
