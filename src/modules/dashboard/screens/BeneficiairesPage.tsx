...
const BeneficiairesPage: React.FC = () => {
    ...
    const contacts: Contact[] = [
        { initial: "M", name: "MOUPEPIDI", id: "1000CCHQ00000031002", bank: "La Peyie EMF", amount: "50 000 XAF", time: "il y a 2 jours", favorite: true, color: "#F44336" },
        { initial: "D", name: "DERLY", id: "1000CCHQ00000031003", bank: "La Peyie EMF", amount: "125 000 XAF", time: "il y a 1 semaine", favorite: true, color: "#009688" },
        { initial: "MK", name: "MARIE KOUASSI", id: "2000EFQ00000045001", bank: "Autre Banque", amount: "30 000 XAF", time: "il y a 1 mois", favorite: false, color: "#FFC107" },
        { initial: "JT", name: "JEAN TRAORE", id: "1000CCHQ00000031004", bank: "La Peyie EMF", amount: "70 000 XAF", time: "il y a 3 semaines", favorite: false, color: "#673AB7" },
    ];
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.statsRow}>
                <StatCard value="3" label="Favoris" icon="⭐" />
                <StatCard value="300k" label="Transféré" icon="💵" />
                <StatCard value="5" label="Total" icon="👥" />
            </View>
...
function QuickUser({ initial, name, color }: { initial: string; name: string; color: string }) {
    return (
...
const styles = StyleSheet.create({
    ...
    quickRow: { flexDirection: "row", justifyContent: "space-around", marginBottom: 20 },
